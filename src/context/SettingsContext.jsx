...
export const BG_OPTIONS = [
  { id: "newsprint", label: "Newsprint", light: "#f5f1e8", dark: "#1a1612", dot: "#d4cebf" },
  { id: "ivory",     label: "Ivory",     light: "#fdfaf2", dark: "#181610", dot: "#e8e0cc" },
  { id: "slate",     label: "Slate",     light: "#eef0f4", dark: "#141618", dot: "#cdd3dc" },
  { id: "sepia",     label: "Sepia",     light: "#f4ede0", dark: "#1c1510", dot: "#d8c8b0" },
  { id: "mint",      label: "Mint",      light: "#edf4ef", dark: "#111a13", dot: "#c2d9c8" },
];
...
export function SettingsProvider({ children }) {
  ...
  return (
    <SettingsContext.Provider value={{ settings, updateSettings, theme, FONT_OPTIONS, BG_OPTIONS }}>
      {children}
