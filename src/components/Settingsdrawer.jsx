...
function SectionLabel({ text, theme }) {
  return (
    <div style={{
      ...
      color: theme.subColor, letterSpacing: 2,
    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: theme.mono, fontSize: 9, letterSpacing: 3, color: theme.subColor, marginBottom: 4 }}>
              CUSTOMIZE
            </div>
            <div style={{ fontFamily: theme.font, fontSize: 20, fontWeight: "bold", letterSpacing: -0.5 }}>
              Newsroom Settings
            </div>
          </div>
          <button
            ...
            style={{
              ...
              color: theme.subColor, fontSize: 16, lineHeight: 1,
              display: "flex", alignItems: "center", justifyContent: "center",
              transition: "all 0.15s",
            }}
            onMouseEnter={e => { e.currentTarget.style.background = theme.barBg; e.currentTarget.style.color = theme.textColor; }}
            onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = theme.subColor; }}
          >
            ×
          </button>
        </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "4px 20px 20px" }}>
          ...
          <div style={{
            ...
            borderRadius: 7, padding: "14px 16px", marginTop: 16,
          }}>
            ...
            <div style={{
              ...
              background: theme.inputBg, borderRadius: 5,
              textAlign: "center",
              border: `1px dashed ${theme.cardBorder}`,
            }}>
              <div style={{ fontFamily: theme.mono, fontSize: 8, color: theme.subColor, letterSpacing: 2, marginBottom: 4 }}>
                MASTHEAD PREVIEW
              </div>
              <div style={{ fontFamily: theme.font, fontSize: 18, fontWeight: "bold", color: theme.textColor, letterSpacing: -0.5 }}>
                {localName || "THE EDITOR"}
              </div>
              <div style={{ fontFamily: theme.font, fontStyle: "italic", fontSize: 10, color: theme.subColor, marginTop: 2 }}>
                {localSlogan || "Truth Without Fear · Est. 1944"}
              </div>
              <div style={{ fontFamily: theme.mono, fontSize: 8, color: theme.subColor, marginTop: 2, opacity: 0.7 }}>
          ...
          <div style={{
            background: theme.cardBg, border: `1px solid ${theme.cardBorder}`,
            borderRadius: 7, padding: "14px 16px", marginTop: 12,
          }}>
              ...
              {FONT_OPTIONS.map(f => (
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ fontFamily: f.value, fontSize: 15, color: theme.textColor }}>
                      {f.label}
                    </div>
                    <div style={{ fontFamily: f.value, fontSize: 10, color: theme.subColor, fontStyle: "italic" }}>
                      A paper of record.
                    </div>
                  </div>
                </div>
          ...
          <div style={{
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      background: selected ? (theme.darkMode ? "#2a2620" : "#fdf8f0") : theme.cardBg,
                      transition: "all 0.15s",
                    }}
                  >
                    <div style={{
                    ...
                    <div style={{ fontFamily: theme.mono, fontSize: 7, color: theme.subColor, letterSpacing: 0.5 }}>
                      {b.label.toUpperCase()}
                    </div>
                  </div>
                );
            ...
            <div style={{
              ...
              paddingTop: 12, borderTop: `1px solid ${theme.cardBorder}`,
            }}>
              <div>
                <div style={{ fontFamily: theme.mono, fontSize: 9, color: theme.subColor, letterSpacing: 2, marginBottom: 2 }}>
                  DARK MODE
                </div>
                <div style={{ fontSize: 11, color: theme.subColor }}>
                  {settings.darkMode ? "Ink on black — the night shift." : "Newsprint — classic daylight."}
                </div>
              </div>
              <ToggleSwitch
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              background: "transparent", color: theme.subColor,
              border: `1px solid ${theme.cardBorder}`,
              borderRadius: 5, fontFamily: theme.mono,
              fontSize: 10, letterSpacing: 1, cursor: "pointer",
              transition: "all 0.15s",
            }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = theme.textColor; e.currentTarget.style.color = theme.textColor; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = theme.cardBorder; e.currentTarget.style.color = theme.subColor; }}
          >
            DISCARD
          </button>
          <button
