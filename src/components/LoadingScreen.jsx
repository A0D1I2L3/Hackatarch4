    ...
    <div style={{
      ...
      {error ? (
        <div style={{ textAlign: "center", maxWidth: 480 }}>
          <div style={{
            fontFamily: theme.font, fontSize: 48, fontWeight: 900,
            color: "#8b1a1a", marginBottom: 16, lineHeight: 1,
          }}>
            ⚠
          </div>
          <div style={{
            fontFamily: theme.font, fontSize: 22, fontWeight: 700,
            marginBottom: 12,
          }}>
            Press Malfunction
          </div>
          <div style={{
            ...
            padding: "14px 18px",
            fontSize: 11, color: "#8b1a1a",
            marginBottom: 20, textAlign: "left", lineHeight: 1.7,
          }}>
            {error}
          </div>
          {error.includes("NO_API_KEY") && (
            <div style={{
              ...
              padding: "14px 18px",
              fontFamily: theme.mono,
              fontSize: 11, color: theme.subColor,
              marginBottom: 20, textAlign: "left", lineHeight: 1.8,
            }}>
              <strong style={{ color: theme.textColor }}>To add your Grok API key:</strong><br />
              1. Create a file called <code>.env</code> in the project root<br />
              2. Add: <code>VITE_GROK_API_KEY=xai-your-key-here</code><br />
        ...
        <>
          ...
          <div style={{ textAlign: "center" }}>
            <div style={{
              fontFamily: theme.font, fontSize: 10, letterSpacing: "0.3em",
              textTransform: "uppercase", color: theme.subColor, marginBottom: 14,
            }}>
              {settings.paperName}
            </div>
            <div style={{
              ...
              <div style={{
                fontFamily: theme.font, fontSize: 28, fontWeight: 900,
          ...
          <div style={{
            ...
            color: theme.subColor, fontStyle: "italic",
